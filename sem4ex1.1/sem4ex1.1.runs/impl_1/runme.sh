...
HD_PWD='D:/vivadoproject/sem4ex1.1/sem4ex1.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sccomp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sccomp.tcl -notrace
