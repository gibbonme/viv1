...
HD_PWD='D:/vivadoproject/sem4ex1.1/sem4ex1.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sccomp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sccomp.tcl
